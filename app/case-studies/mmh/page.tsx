  ...
  return (
    <main id="main-content" className="min-h-screen bg-jamarq-black text-jamarq-white">
        ...
        <div className="max-w-5xl mx-auto px-5 md:px-10 space-y-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="grid grid-cols-1 gap-4">
              {mmhCaseStudyContent.projectOverview.facts.map((fact) => (
                <div key={fact.label} className="p-4 rounded-lg border border-slate bg-jamarq-black/40">
      ...
      <section className="py-24 md:py-32 bg-steel" aria-label="Solution details">
        <div className="max-w-6xl mx-auto px-5 md:px-10">
          <h2 className="text-3xl md:text-4xl font-semibold text-center mb-12">{mmhCaseStudyContent.solution.heading}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {mmhCaseStudyContent.solution.sections.map((section) => (
              <div key={section.title} className="p-6 rounded-xl border border-slate bg-jamarq-black/40 space-y-4">
      ...
      <section className="py-24 md:py-32" aria-label="Results">
        <div className="max-w-5xl mx-auto px-5 md:px-10">
          <h2 className="text-3xl md:text-4xl font-semibold mb-10">{mmhCaseStudyContent.results.heading}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {mmhCaseStudyContent.results.categories.map((category) => (
              <div key={category.title} className="p-6 border border-slate rounded-xl bg-jamarq-black/40">
      ...
      <section className="py-24 md:py-32" aria-label="Full case study">
        <div className="max-w-4xl mx-auto text-center px-5 md:px-10">
          ...
          <a
            href="mailto:jason@jamarq.digital?subject=MMH Full Case Study Request"
