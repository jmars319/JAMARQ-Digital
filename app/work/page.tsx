...
export default async function WorkPage() {
  ...
  const highlights = [
    ...
    },
    {
      ...
      copy: "The public site, admin workflow, and web systems are planned together."
    }
  ];
        ...
        <div className="max-w-6xl mx-auto px-5 md:px-10 grid gap-12 md:grid-cols-[minmax(0,1fr)_320px] items-start">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl font-semibold leading-tight">
              Selected work across websites, rebuilds, and web systems.
            </h1>
            <p className="text-lg text-jamarq-gray leading-relaxed">
              Work for independent businesses and established teams across custom websites, rebuilds, and web systems. Each project is documented with real outcomes and technical detail.
            </p>
